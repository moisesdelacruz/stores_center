...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0003_auto_20170514_1500'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='product',
            name='discount',
            field=product.models.IntegerRangeField(null=True),
        ),
        migrations.AddField(
            model_name='product',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency=b'USD', max_digits=10),
        ),
        migrations.AddField(
            model_name='product',
            name='price_currency',
